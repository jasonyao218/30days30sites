	...
	function bannerLoop(){
		if(bannerStatus === 1){
			...
			setTimeout(function(){
				...
				document.getElementById("imgban4").style.zIndex = "200";
			}, 500);
			setTimeout(function(){
			...
			setTimeout(function(){
				...
				document.getElementById("imgban1").style.zIndex = "200";
			}, 500);
			setTimeout(function(){
			...
			setTimeout(function(){
				...
				document.getElementById("imgban2").style.zIndex = "200";
			}, 500);
			setTimeout(function(){
			...
			setTimeout(function(){
				...
				document.getElementById("imgban3").style.zIndex = "200";
			}, 500);
			setTimeout(function(){
